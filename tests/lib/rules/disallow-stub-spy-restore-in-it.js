...
const invalidTestTemplates = [
  ...
  },
  {
    ...
    errors: [
      {
        message: '`stub` is not allowed to use inside `{{TEST}}`.',
        type: 'CallExpression',
      },
    ],
  },
  ...
  },
  {
    ...
    errors: [
      {
        message: '`spy` is not allowed to use inside `{{TEST}}`.',
        type: 'CallExpression',
      },
    ],
  },
  ...
  },
  {
    ...
    errors: [
      {
        message: '`stub` is not allowed to use inside `{{TESTSKIP}}`.',
        type: 'CallExpression',
      },
    ],
  },
