...
const invalidTestTemplates = [
  {
    ...
    errors: [
      {
        message:
          '`{{TEST}}` has a complexity of {{COMPLEXITY}}. Maximum allowed is 0.',
        type: 'CallExpression',
      },
    ],
  },
  ...
  },
  {
    ...
    errors: [
      {
        message:
          '`{{TESTSKIP}}` has a complexity of {{COMPLEXITY}}. Maximum allowed is 0.',
        type: 'CallExpression',
      },
    ],
  },
  {
    ...
    errors: [
      {
        message: '`{{TEST}}` has a complexity of 4. Maximum allowed is 0.',
        type: 'CallExpression',
      },
    ],
  },
  {
    ...
    errors: [
      {
        message: '`{{TESTSKIP}}` has a complexity of 4. Maximum allowed is 0.',
        type: 'CallExpression',
      },
    ],
  },
