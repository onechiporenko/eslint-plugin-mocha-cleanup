...
module.exports = function (context) {
  ...
  return {
    ...
    "MemberExpression": function (node) {
      ...
      var arg;
      var isSinonAssert = n.isSinonAssert(node);
      var isChaiAssert = n.isChaiAssert(node);
      if (isChaiAssert || isSinonAssert) {
        arg = isSinonAssert ? obj.get(node, "parent.parent.arguments.0") : obj.get(node, "parent.arguments.0");
        if (!arg) {
          return context.report(node, emptyArgMessage);
        }
        if (arg.type === "BinaryExpression") {
